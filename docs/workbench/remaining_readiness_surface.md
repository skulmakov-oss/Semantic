...
- [ ] legacy TS/Tauri Workbench retired from active dependency surface (see `docs/history/workbench_ts_tauri_legacy.md`)
...
- legacy TS/Tauri Workbench retired per `docs/history/workbench_ts_tauri_legacy.md`
