...
| Arithmetic overflow | Numeric operation exceeds the representable runtime range. | `sm-vm` | `E2-test: crates/sm-vm/src/semcode_vm.rs::vm_traps_on_i32_division_min_by_negative_one; E2-test: crates/sm-vm/src/semcode_vm.rs::vm_traps_on_i32_modulo_min_by_negative_one; E1-code: crates/sm-vm/src/semcode_vm.rs::RuntimeTrap::ArithmeticOverflow` | VM execution | frozen | VM, CLI, diagnostics |
