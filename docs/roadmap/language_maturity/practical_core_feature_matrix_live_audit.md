...
| FM-025 | Option / Result | `Option` shape | confirmed-partial | `E3-pipeline: tests/canonical_examples.rs::canonical_positive_examples_check_run_compile_and_verify; E2-test: crates/sm-front/src/parser.rs::rustlike_parser_accepts_option_and_result_standard_form_types; E2-test: crates/sm-front/src/typecheck.rs::option_and_result_standard_forms_typecheck_in_typed_positions; E2-test: crates/sm-ir/src/legacy_lowering.rs::lower_option_and_result_standard_forms_to_canonical_make_adt_ir; E2-test: crates/sm-vm/src/semcode_vm.rs::vm_runs_option_and_result_standard_form_paths; E2-test: tests/g1_frontend_trust.rs::g1_frontend_negative_suite_reports_expected_diagnostics` | check -> compile -> verify -> run-smc | dedicated PCC-6 fixture packaging / closeout evidence missing | PCC-6 | value | Practical Hell | package dedicated PCC-6 fixtures |
| FM-026 | Option / Result | `Result` shape | confirmed-partial | `E3-pipeline: tests/canonical_examples.rs::canonical_positive_examples_check_run_compile_and_verify; E2-test: tests/g1_real_program_trial.rs::g1_rule_state_decision_checks_and_runs; E2-test: crates/sm-front/src/parser.rs::rustlike_parser_accepts_option_and_result_standard_form_types; E2-test: crates/sm-front/src/typecheck.rs::option_and_result_standard_forms_typecheck_in_typed_positions; E2-test: crates/sm-ir/src/legacy_lowering.rs::lower_option_and_result_standard_forms_to_canonical_make_adt_ir; E2-test: crates/sm-vm/src/semcode_vm.rs::vm_runs_option_and_result_standard_form_paths; E2-test: tests/g1_frontend_trust.rs::g1_frontend_negative_suite_reports_expected_diagnostics` | check -> compile -> verify -> run-smc | dedicated PCC-6 fixture packaging / closeout evidence missing | PCC-6 | value | Practical Hell | package dedicated PCC-6 fixtures |
