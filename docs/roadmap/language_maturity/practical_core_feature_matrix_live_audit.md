...
| FM-041 | CLI | project model v0 | confirmed-partial | `E1-code: crates/smc-cli/src/package_manifest.rs::admit_package_entry_module; E1-code: crates/smc-cli/src/package_manifest.rs::resolve_package_import_path; E2-test: crates/smc-cli/src/package_manifest.rs::parse_package_manifest_accepts_first_wave_directives; E2-test: crates/smc-cli/src/package_manifest.rs::validate_package_manifest_accepts_local_path_dependency_inventory; E2-test: crates/smc-cli/src/package_manifest.rs::admit_package_entry_module_maps_entry_into_package_context; E2-test: crates/smc-cli/src/package_manifest.rs::resolve_package_import_path_maps_local_path_dependency_alias; E2-test: tests/pcc9_project_model_acceptance.rs::pcc9_single_file_baseline_passes_full_cli_path; E2-test: tests/pcc9_project_model_acceptance.rs::pcc9_package_manifest_baseline_parses_and_validates; E2-test: tests/pcc9_project_model_acceptance.rs::pcc9_package_manifest_local_dependency_inventory_is_deterministic; E2-test: tests/pcc9_project_model_acceptance.rs::pcc9_package_manifest_entry_admission_accepts_entry_under_module_root; E2-test: tests/pcc9_project_model_acceptance.rs::pcc9_package_manifest_import_resolution_resolves_local_dependency_alias; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_manifest_malformed_rejects_parse; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_manifest_missing_package_rejects_parse; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_manifest_invalid_format_rejects_validation; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_manifest_invalid_dep_shape_rejects_parse; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_manifest_missing_manifest_dir_rejects_parse; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_manifest_missing_module_root_rejects_parse; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_entry_admission_rejects_path_escape; E2-test: tests/pcc9_project_model_diagnostics.rs::pcc9_import_resolution_rejects_unresolved_dependency_alias; E0-doc: docs/roadmap/language_maturity/package_manifest.md; E0-doc: docs/roadmap/language_maturity/package_worked_example.md; E0-doc: docs/roadmap/language_maturity/pcc9_project_model_contract.md; E0-doc: docs/roadmap/language_maturity/pcc9_project_model_live_audit.md` | integration test | admitted Semantic.package baseline is closed; manual project-root creation is the current FR-4 baseline; `smc new` scaffolding is out of current readiness scope | PCC-9 | none | Practical Hell | audit |
