...
| FM-028 | Collections | `Map<K,V>` | confirmed-partial | `E3-pipeline: tests/pcc7_map_acceptance.rs::pcc7_map_empty_contextual_fixture_passes_full_cli_path; E3-pipeline: tests/pcc7_map_acceptance.rs::pcc7_map_basic_insert_lookup_fixture_passes_full_cli_path; E3-pipeline: tests/pcc7_map_acceptance.rs::pcc7_map_persistent_update_fixture_passes_full_cli_path; E3-pipeline: tests/snake_benchmark_gap_matrix.rs::snake_benchmark_positive_surface_passes_end_to_end; E2-test: tests/snake_benchmark_gap_matrix.rs::snake_benchmark_negative_gap_suite_reports_current_blockers; E0-doc: docs/roadmap/language_maturity/first_wave_map_surface.md; E0-doc: docs/roadmap/language_maturity/core_trust_freeze/runtime_value_registry.md` | check -> compile -> verify -> run-smc | contextual `map_empty()` typing, deterministic iteration policy, missing-key behavior, and memory/quota evidence are still missing | PCC-7 | value/trap | Practical Hell | package PCC-7 fixtures and close policy gaps |
