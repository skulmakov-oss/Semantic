...
| O07 | Binding Graph | `crates/prom-ui::binding_graph` | target module | LANDED foundation through #1491; observation/dirty v0 contract frozen through #1513; crate-private engine implementation and qualification landed through #1514; crate-private caller-supplied Semantic observation adapter v0 implementation and qualification carried by this change; live Semantic reads and runtime integration remain absent | read-side relationships between structure, roles, semantic refs, action surfaces, evidence anchors | patch stream, denial/recovery, task/control semantics, runtime effects, admission | may adapt slot-intent carrier evidence |
