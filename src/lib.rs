...
pub mod semcode_format {
    pub use sm_emit::{
        ...
        CAP_GATE_SURFACE, CAP_SEQUENCE_VALUES, CAP_STATE_QUERY, CAP_STATE_UPDATE, CAP_TEXT_VALUES,
        HEADER_V0, HEADER_V1, HEADER_V10, HEADER_V2, HEADER_V3, HEADER_V4, HEADER_V5, HEADER_V6,
        HEADER_V7, HEADER_V8, HEADER_V9, MAGIC0, MAGIC1, MAGIC10, MAGIC2, MAGIC3, MAGIC4, MAGIC5,
...
pub mod semcode_vm {
    pub use sm_vm::{
        ...
        run_verified_semcode_with_host_and_capabilities_and_config, ClosureValue, DebugSymbol,
        Frame, FunctionBytecode, RuntimeError, Value, VM,
    };
}
#[cfg(feature = "std")]
