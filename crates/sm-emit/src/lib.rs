...
pub use sm_ir::semcode_format::{
    ...
    CAP_SEQUENCE_VALUES, CAP_STDOUT, CAP_STATE_QUERY, CAP_STATE_UPDATE, CAP_TEXT_VALUES,
    CAP_CLOSURE_VALUES,
    HEADER_V0, HEADER_V1, HEADER_V2, HEADER_V3, HEADER_V4, HEADER_V5, HEADER_V6, HEADER_V7,
    HEADER_V8, HEADER_V9, HEADER_V10, HEADER_V11, HEADER_V12, HEADER_V13, HEADER_V14, HEADER_V15,
    HEADER_V16,
    MAGIC0, MAGIC1, MAGIC2, MAGIC3, MAGIC4, MAGIC5, MAGIC6, MAGIC7, MAGIC8, MAGIC9,
