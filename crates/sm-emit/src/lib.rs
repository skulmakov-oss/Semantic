...
pub use sm_ir::semcode_format::{
    ...
    SemcodeFormatError, SemcodeHeaderSpec, CAP_CLOCK_READ, CAP_CLOSURE_VALUES, CAP_DEBUG_SYMBOLS,
    CAP_EVENT_POST, CAP_F64_MATH, CAP_FX_MATH, CAP_FX_VALUES, CAP_GATE_SURFACE, CAP_MAP_VALUES,
    CAP_OWNERSHIP_FIELD_PATHS, CAP_OWNERSHIP_PATHS, CAP_PRNG, CAP_SEQUENCE_ITERATION,
    CAP_SEQUENCE_VALUES, CAP_STATE_QUERY, CAP_STATE_UPDATE, CAP_STDOUT, CAP_TEXT_VALUES, HEADER_V0,
    HEADER_V1, HEADER_V10, HEADER_V11, HEADER_V12, HEADER_V13, HEADER_V14, HEADER_V15, HEADER_V16,
    HEADER_V2, HEADER_V3, HEADER_V4, HEADER_V5, HEADER_V6, HEADER_V7, HEADER_V8, HEADER_V9, MAGIC0,
    MAGIC1, MAGIC10, MAGIC11, MAGIC12, MAGIC13, MAGIC14, MAGIC15, MAGIC16, MAGIC2, MAGIC3, MAGIC4,
