...
mod frontend {
    pub use sm_front::{
        ...
        type_check_function_with_table, type_check_program, AdtTable, AstArena, BinaryOp,
        BlockExpr, CompileProfile, Expr, ExprId, FnTable, FrontendError, Function,
        GrammarAdmission, LogosProgram, MatchExpr, OptLevel, Program, QuadVal, RecordTable,
        ScopeEnv, Stmt, StmtId, SymbolId, Token, Type, UnaryOp,
    };
