...
pub mod semcode_format {
    pub use crate::local_format::{
        ...
        HEADER_V9, HEADER_V10, HEADER_V11, HEADER_V12, HEADER_V13, HEADER_V14, MAGIC0, MAGIC1,
        MAGIC2, MAGIC3, MAGIC4, MAGIC5, MAGIC6, MAGIC7, MAGIC8, MAGIC9, MAGIC10, MAGIC11, MAGIC12,
        MAGIC13, MAGIC14,
